<h1 align="left">Dashboard de Vendas em Python</h1>
...
#### Código em Python, com Poetry para gestão de ambiente virtual (.venv.)
...
- Back end: Python/Poetry/Flask


## Layout web
![Web 1](https://github.com/BalbinaRaquel/dash_vendas/blob/main/Site.png)
...
```bash
# clonar repositório
git clone https://github.com/BalbinaRaquel/dash_vendas.git
